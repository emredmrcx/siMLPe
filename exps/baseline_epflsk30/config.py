...
"""Dataset Config"""
C.epfl_anno_dir = '/mnt/mahzen/epfl_smart_kitchen_30/Public_release_pose'
C.motion = edict()

C.motion.epfl_input_length = 50
C.motion.epfl_input_length_dct = 50
C.motion.epfl_target_length_train = 10
C.motion.epfl_target_length_eval = 25
C.motion.dim = 51
C.motion.sample_rate = 2 #1
...
C.motion_mlp.seq_len = C.motion.epfl_input_length_dct
